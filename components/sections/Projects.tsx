  ...
  return (
    <section id="projects" className="py-20 md:py-32 bg-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {featuredProjects.map((project, index) => (
            ...
            >
              <Link href={`/projects/${project.slug}`}>
                <article className="group bg-gray-900 border border-gray-800 rounded-lg overflow-hidden hover:border-gray-600 transition-all duration-300">
                  {/* Project Image */}
        ...
        {portfolioData.projects.length > featuredProjects.length && (
          <motion.div
